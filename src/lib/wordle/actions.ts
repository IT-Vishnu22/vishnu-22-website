...
export async function addPlayed(studentId: string | undefined, group: string | null, win: boolean) {
...
export async function didPlay(studentId: string | undefined, group: string | null) {
    console.log("played: ", studentId, group);
