...
export default function News04() {
    return (
        <div className="h-full w-full bg-[linear-gradient(to_top,rgba(196,125,118,0.5),rgba(240,225,219,0.5)),url('/intaniastorypics/background.svg')] px-5 py-5">
            ...
            <div>
                <h2 className="relative ml-5 mt-3 inline-block max-w-full break-words font-athiti text-[15px] text-xs font-bold italic text-blue-1">
                    ผ้ายันต์
                </h2>
            </div>
            ...
            <div>
                <h2 className="relative mb-3 inline-block max-w-full break-words font-athiti text-xs font-medium text-black">
                    &emsp; &emsp;ผ้ายันต์สำหรับชาววิศวฯ
                    เปรียบเสมือนเครื่องรางให้น้อง ๆ สอบผ่าน
                    ใช้ชีวิตภายในคณะวิศวฯ โดยสวัสดิภาพราบรื่น แต่จริง ๆ
                    แล้วสมัยก่อนผ้ายันต์ไม่ได้ใช้เป็นเครื่องรางเหมือนอย่างสมัยนี้นะ
                    แต่ก่อนพวกรุ่นพี่ก็จะแจกผ้ายันต์เอาไว้ให้น้อง ๆ
                    เขียนชื่อแล้วก็เย็บบนเสื้อช็อปให้รู้ว่าใครเป็นใคร
                    ไม่ได้เป็นเครื่องรางพิเศษอะไร
                    ก็พึ่งมามีความสำคัญในช่วงหลังนี่แหละ
                </h2>
            </div>
            ...
            <div>
                <h2 className="relative ml-5 mt-5 inline-block max-w-full break-words font-athiti text-[15px] text-xs font-bold italic text-blue-1">
                    ติ้งโครง เนคไทโครง
                </h2>
            </div>
            ...
            <div>
                <h2 className="relative mb-3 inline-block max-w-full break-words font-athiti text-xs font-medium text-black">
                    &emsp;
                    &emsp;บางครั้งที่เราเห็นพวกรุ่นพี่ใส่เนคไทหรือติ้งที่มันหน้าตาแปลก
                    ๆ มีแต่โครงอย่างเดียว ไม่ได้เป็นพระเกี้ยวเหมือนอย่างคณะอื่น
                    จริง ๆ แล้วมันเป็นเอกลักษณ์ของวิศวฯ เรานะ
                    เคยมีอยู่ช่วงหนึ่งที่วิศวฯ ตั้งตนเป็น College of Engineering
                    ไม่ใช่แค่ Faculty of Engineering
                    แล้วเราก็สร้างกิจกรรมของเราเอง เสมือนเป็นมหาวิทยาลัยหนึ่ง
                    ซึ่งตัวเนคไทกับติ้งที่มี design
                    ต่างออกไปก็เกิดขึ้นมาในยุคนี้นั่นเอง
                </h2>
            </div>
            ...
            <div>
                <h2 className="relative mb-3 inline-block max-w-full break-words font-athiti text-xs font-medium text-black">
                    ...
                    รุ่นพี่เค้าก็จะแจกสมุดเชียร์มาให้
                    ขนาดจะพอดีกับกระเป๋าอกเสื้อพอดีเลย ใส่พกติดตัวไปไหนมาไหนตลอด
                    ในปัจจุบันเองก็ยังมีสมุดเชียร์แจกให้น้อง ๆ กันอยู่เหมือนกัน
                    แถมยังมีสมุดเชียร์ออนไลน์ให้น้องไปฟังไปดูเนื้อเพลงกันด้วยนะ
                </h2>
            </div>

            <div>
                <h2 className="relative ml-5 inline-block max-w-full break-words font-athiti text-[15px] text-xs font-bold italic text-blue-1">
                    เกียร์
                </h2>
            </div>
            ...
            <div>
                <h2 className="relative mb-3 inline-block max-w-full break-words font-athiti text-xs font-medium text-black">
                    ...
                    แต่ใครบ้างจะรู้ความหมายที่แท้จริงของมัน
                    เกียร์นั้นเมื่ออยู่เดี่ยว ๆ
                    ย่อมไม่อาจทำงานสร้างผลผลิตออกไม่ได้
                    ไม่ว่าเกียร์นั้นจะขนาดใหญ่หรือแข็งแรกมากแค่ไหน
                    แต่มันจะต้องเข้าไปประกอบไปด้วยเกียร์ตัวอื่น ๆ
                    ทั้งใหญ่ทั้งเล็ก จะขาดเกียร์อันใดอันหนึ่งไปไม่ได้
                    ก็เหมือนชาววิศวฯ เรา
