  ...
  return (
    <div>
      ...
      <div className="mx-auto mt-5 max-w-[80%] gap-6">
        ...
        <div className="mt-5 group relative col-span-2 flex h-48 items-end overflow-hidden rounded-lg bg-gray-100 shadow-lg">
          <img
      ...
      <div>
          ...
          ฟุตบอลประเพณีจุฬา-ธรรมศาสตร์จริงๆ แล้วมีต้นกำเนิดมาจากการแข่งขันเรือประเพณีระหว่างมหาวิทยาลัยออกซฟอร์ดและมหาวิทยาลัยเคมบริดจ์ในสหราชอาณาจักร โดยมีจุดประสงค์เพื่อจะสานสัมพันธ์อันดีระหว่างนิสิตจุฬาและนิสิตธรรมศาสตร์ จัดงานที่สนามศุภชลาศัย กรีฑาสถานแห่งชาติ ถนนพระรามที่ 1 แขวงวังใหม่ เขตปทุมวัน กรุงเทพมหานคร เป็นประจำทุกปี กองเชียร์ของมหาวิทยาลัยเจ้าภาพจะใช้อัฒจันทร์ฝั่งทิศเหนือ อีกฝ่ายจะใช้อัฒจันทร์ฝั่งทิศใต้
          </h2>
        </div>

        <div>
          <h2 className="relative mb-3 ml-5 mt-1 inline-block max-w-full break-words font-roboto-condensed text-xs text-black italic">
          “ เดี๋ยวนี้ฟุตบอลประเพณีเป็นอย่างไรไม่รู้ สมัยก่อนรุ่นผมเป็นน้องใหม่ธรรมศาสตร์
            เป็นเจ้าภาพ หรือจุฬาฯ เป็นเจ้าภาพ ถ้าธรรมศาสตร์เป็นเจ้าภาพเวลาเสร็จสิ้นการกีฬาแล้ว
            ธรรมศาสตร์จะเปิดมหาวิทยาลัยเขาแล้วจุฬาฯ ก็จะไปฉลองกันที่โน่นใครชนะไม่เป็นไร
            แต่เขาจะมีข้าวแจกให้พวกเรา ถ้าจุฬาฯ เป็นเจ้าภาพเราก็จะมีข้าวให้เขา 
      ...
      <div className="mx-auto mt-5 grid max-w-[80%] grid-cols-4 gap-4 gap-6">
        ...
        <div>
            <h2 className="relative mb-3 ml-5 mt-5 inline-block max-w-full break-words font-roboto-condensed text-xs text-black">
            นอกจากแข่งกีฬาแล้วยังมีการแข่งกิจกรรมเชื่อมสัมพันธ์ระหว่างนิสิตจุฬาฯ กับนักศึกษามหาวิทยาลัยธรรมศาสตร์ เช่น การเดินพาเหรด การเชียร์ การแปรอักษร            </h2>
        </div>

        <div>
            <h2 className="relative mb-3 ml-5 mt-5 inline-block max-w-full break-words font-roboto-condensed text-xs text-black italic">
                <span>“ คืนนั้นมีการละเล่น” </span><br/>
                <span>“นี่คือสิ่งประทับใจสมัยก่อน ที่ผมเคยพูดว่ามีความสุขเช้าก็นั่งรถแห่กันไป”</span><br/>
                <span>“ธรรมศาสตร์ก็ขับมาจุฬาฯ จุฬาฯ ก็ไปธรรมศาสตร์ ไม่รู้มันบ้าบอ”</span>
            </h2>
        </div>
