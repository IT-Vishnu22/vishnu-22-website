    ...
    <div className="h-full w-full bg-[linear-gradient(to_top,rgba(196,125,118,0.5),rgba(240,225,219,0.5)),url('/intaniastorypics/background.svg')] px-5 py-5">
      ...
      <div>
        <h2 className="relative mb-3 ml-5 mt-5 inline-block max-w-full break-words font-roboto-condensed text-xs text-black">
          ก่อนจะมาเป็นวิศวฯ จุฬาอย่างทุกวันนี้ คณะวิศวฯ
          เคยเป็นแค่โรงเรียนช่างที่ไม่ได้มีหลักสูตรปริญญา
          และไม่ได้รับการยอมรับจากต่างชาติในฐานะมหาวิทยาลัยสากล จนกระทั่ง วันที่
          9 ตุลาคม พ.ศ. 2481 พระเจริญวิศวกรรม (นายเจริญ เชนะกุล)
          ซึ่งดำรงตำแหน่งคณบดี คณะวิศวกรรมศาสตร์ จุฬาลงกรณ์มหาวิทยาลัย
          ...
          แยกแผนกการเรียนการสอนในชั้นปีที่ 4 เป็น 3 แผนก หรือก็คือภาควิชาขึ้นมา
          3 ภาควิชาแรกนั่นก็คือ แผนกวิศวกรรมโยธา แผนกวิศวกรรมไฟฟ้า
          และแผนกวิศวกรรมเครื่องกล
        </h2>
      </div>

      <div>
        <h2 className="relative mb-3 ml-5 mt-1 inline-block max-w-full break-words font-roboto-condensed text-xs text-black">
          ทางด้านอาจาย์ผู้สอน พระเจริญวิศวกรรมได้ติดต่ออาจารย์ชาวต่างประเทศ 2
          ...
          ศาสตราจารย์ฮันส์ บันตลิ (Professor Hans Bantle) ชาวสวิตเซอร์แลนด์
          ทำหน้าที่เป็นหัวหน้าแผนกวิศวกรรมเครื่องกล ส่วนพระเจริญวิศวกรรม
          ทำหน้าที่เป็นหัวหน้าแผนกวิศวกรรมโยธา
      ...
      <div>
        <h2 className="relative mb-3 ml-5 mt-5 inline-block max-w-full break-words font-roboto-condensed text-xs italic text-black">
          ...
          <span>
            ...
            ประเทศชาติเจริญได้ก็เพราะมีวิศวกรมากๆ
          </span>
          <br />
      ...
      <div>
        <h2 className="relative mb-3 ml-5 mt-5 inline-block max-w-full break-words font-roboto-condensed text-xs text-black">
          ในที่สุดคณะวิศวกรรมศาสตร์ จุฬาลงกรณ์มหาวิทยาลัย
