        ...
        <div className="h-full w-full bg-[linear-gradient(to_top,rgba(196,125,118,0.5),rgba(240,225,219,0.5)),url('/intaniastorypics/background.svg')] px-5 py-5">
            ...
            <div className="mt-5 flex items-center justify-center space-x-4">
                ...
                <h1 className="font-athiti text-[24px] font-bold text-blue-1">
                    <span>รีวิวชีวิตปี 1 วิศวฯ จุฬา</span>
                </h1>
            </div>

            <div className="paragraph-container">
                <h2 className="relative mb-3 ml-5 mt-2 inline-block max-w-full break-words text-center font-athiti text-xs italic text-black">
                    <span>
                        “พอชีวิตช่วงดีที่สุดจนตราบเท่าทุกวันนี้ คือ
                        ถ้าถามว่าผมในช่วงอายุ 68 ปี
                    </span>
                    <br />
                    <span>
                        ถามว่าช่วงไหนดีที่สุด
                        ช่วงหนึ่งของชีวิตคือช่วงที่เป็นนิสิตวิศวจุฬา”
                    </span>
                </h2>
                ...
                <h2 className="relative mb-3 mt-5 inline-block max-w-full break-words font-athiti text-xs font-medium text-black">
                    &emsp; &emsp;ตลอด 1 ปีของการเป็นนิสิตวิศวฯ จุฬา
                    พูดได้คำเดียวเลยว่า “เหนื่อย”
                    แต่มันเป็นความเหนื่อยที่คุ้มค่า เรียนเหนื่อย เล่นเหนื่อย
                    เที่ยวเหนื่อย แต่สนุกมั้ย มันสนุกนะ พอจบปี 1
                    แล้วมองย้อยกลับไปดูแรงกายแรงใจที่ตัวเองทุ่มลงไป
                    มันคุ้มค่าว่ะ ชีวิตปี 1 มันคือช่วงที่ใคร ๆ
                    ก็บอกว่าเป็นช่วงเวลาที่สนุกที่สุดในชีวิต
                    ตอนเข้ามาครั้งแรกมันก็ยังไม่เข้าใจหรอกว่าสนุกตรงไหน
                    เรียนก็แสนจะยาก เรียนไม่ทันไรก็สอบละ ชีวิตวนลูป อ่านหนังสือ
                    ทำกิจกรรม อ่านหนังสือไปเรื่อย ๆ ยิ่งปี 1
                    เป็นปีที่เรียนยากที่สุดละ แต่มันสนุกตรงไหนรู้มั้ย
                    มันสนุกเพื่อน สนุกประสบการณ์ มันกลับมานั่งคิดว่า เออ
                    ฉันเจ๋งว่ะ ใช้ชีวิตคุ้มว่ะ
                </h2>
            </div>
