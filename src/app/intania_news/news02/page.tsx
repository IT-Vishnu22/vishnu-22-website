...
export default function Home() {
  return (
    <div className="h-full w-full bg-[linear-gradient(to_top,rgba(196,125,118,0.5),rgba(240,225,219,0.5)),url('/intaniastorypics/background.svg')] px-5 py-5">
      ...
      <div>
        <h2 className="relative mb-3 ml-5 mt-5 inline-block max-w-full break-words font-roboto-condensed text-[15px] text-xs font-bold text-blue-1">
      ...
      <div>
        <h2 className="relative mb-3 inline-block max-w-full break-words font-roboto-condensed text-xs text-black">
          ...
          ผมเห็นเพื่อนหลายแบบเลยนะ บางคนก็เรียนอย่างเดียวกิจกรรมไม่เอาเลย
      ...
      <div>
        <h2 className="relative mb-3 ml-5 mt-5 inline-block max-w-full break-words font-roboto-condensed text-xs italic text-black">
          ...
          <br />
          <span>
            “รวมๆ แล้ว สัก 30 ก็จะมีโยธา ตามมาด้วยไฟฟ้าและพวกเครื่องกล
            เหมืองแร่เรียกว่าหยุมหยิม”
          </span>
          <br />
