...
export default function Leaderboard() {
  ...
  return (
    <section className="flex flex-col pb-5 w-full items-center max-h-full min-h-screen transition-all "
      style={{backgroundColor: (showType ==="game" ? "#F0E5D7" : "#B0C6B5")}}
    >
      ...
      {/* Toggle Icon */}
      <div className="absolute top-[38px] right-[20px] cursor-pointer" onClick={(e)=>{
        handleToggle()
      }}>
        <ToggleIcon />
      </div>
