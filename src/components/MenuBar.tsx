...
export function MenuBottomBar() {
    ...
    return (
        <NavigationMenu className="fixed z-100 w-full bottom-0 sm:hidden block h-[65px] bg-white border-t-[4px] border-black flex flex-row items-center justify-center">
...
export function MenuTopBar() {
    ...
    return (
        <>
            <div className="z-100 hidden w-full h-[65px] top-0 left-0 right-0 fixed bg-[#FEEBED] sm:flex justify-between items-center px-4">
            ...
            <div className="w-full h-[65px] top-0 left-0 right-0 z-1000 fixed flex justify-end items-center px-8 sm:hidden">
                {
                    token ?
                        <Link href={"/"} className="z-1000 rounded-3xl px-5 py-1 bg-[#ECD8C1]">
